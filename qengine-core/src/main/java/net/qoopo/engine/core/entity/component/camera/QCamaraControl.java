 ...
 * @author alberto
 */
public class QCamaraControl extends EntityComponent {
    ...
    public QCamaraControl(Camera camara) {
        this.camara = camara;
        configurar();
    }
            ...
            public void keyPressed(KeyEvent evt) {
                ...
                switch (evt.getKeyCode()) {
                    ...
                    case KeyEvent.VK_NUMPAD7:
                        camara.lookAtTarget(QVector3.of(0, 10, 0), QVector3.zero, QVector3.unitario_y);
                        break;
