 ...
 * @author alberto
 */
public class QEsfera extends QShape {
    ...
    public void build() {
        ...
        // System.out.println("Esfera generada { vertices: " + this.vertices.length + "
        // , triangulos:" + this.primitivas.length + "}");
        // System.out.println("numVertices=" + numVertices);
        // QUtilNormales.calcularNormales(this); // al clacular las normales utilizando
        // esta herramienta, hay un error con la cara que cierra la esfera
