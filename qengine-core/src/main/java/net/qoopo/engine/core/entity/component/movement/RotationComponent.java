 ...
 */
public class RotationComponent implements EntityComponent, UpdatableComponent {
    ...
    public RotationComponent(Cuaternion cuaternion) {
    ...
    public RotationComponent(QVector3 angles) {
        this.radiansX = angles.x;
        this.radiansY = angles.y;
        this.radiansZ = angles.z;
    ...
    public RotationComponent(float radiansX, float radiansY, float radiansZ) {
