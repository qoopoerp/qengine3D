 ...
 * @author alberto
 */
public class QProcesadorImplF3 extends QProcesadorColision {

    @Override
    public void procesarColision(QObjetoRigido obj1, QObjetoRigido obj2) {
        QObjetoRigido objeto1 = obj1;
        QObjetoRigido objeto2 = obj2;
//        if (objeto1.tipoDinamico == QObjetoRigido.DINAMICO) {
//--------------------------------------------------------------------------------------------------------------
//        System.out.println("Inicio proceso colision entre " + objeto1.name + " - " + objeto2.name);
//            System.out.println("");
//            System.out.println("Masa ob1 = " + objeto1.getMasa() + " Velocidad inicial objeto 1=" + objeto1.velocidadLinear.toString() + " modulo=" + objeto1.velocidadLinear.length());
//            System.out.println("Masa ob2 = " + objeto2.getMasa() + "Velocidad final objeto 2=" + objeto2.velocidadLinear.toString() + " modulo=" + objeto2.velocidadLinear.length());
