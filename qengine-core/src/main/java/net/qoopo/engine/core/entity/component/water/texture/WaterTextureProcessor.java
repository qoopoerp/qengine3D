 ...
 * @author alberto
 */
public class WaterTextureProcessor extends QProcesadorTextura {
    ...
    public WaterTextureProcessor(QTextura texturaA, QTextura texturaB) {
        this.texturaA = texturaA;
        this.texturaB = texturaB;
        this.texturaDistorcion = new QTextura();
        textura = new QTextura();
        setProyectada(true);// la textura de salira ya esta proyectada
    }

    public WaterTextureProcessor(QTextura texturaA, QTextura texturaB, QTextura distorcion) {
        this.texturaA = texturaA;
        this.texturaB = texturaB;
