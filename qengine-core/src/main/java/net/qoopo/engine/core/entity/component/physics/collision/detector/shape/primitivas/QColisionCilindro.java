 ...
 * @author alberto
 */
public class QColisionCilindro extends CollisionShape {

    private float altura;
    private float radio;

    public QColisionCilindro() {
    }

    public QColisionCilindro(float altura, float radio) {
        this.altura = altura;
        this.radio = radio;
    }
...
//validar contra otro estera
        if (otro instanceof QColisionCilindro) {
        }
