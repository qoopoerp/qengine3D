 ...
 * @author alberto
 */
public class QVertex implements Serializable {

    public static final QVertex ZERO = new QVertex(0, 0, 0, 1);
    ...
    public QVertex(float x, float y, float z, float w) {
        location.x = x;
        location.y = y;
        location.z = z;
        location.w = w;
    ...
    public QVertex(float x, float y, float z, float w, float u, float v) {
        location.x = x;
        location.y = y;
        location.z = z;
        location.w = w;
    ...
    public QVertex(float x, float y, float z) {
        location.x = x;
        location.y = y;
        location.z = z;
        location.w = 1;
    ...
    public QVertex(float x, float y, float z, float u, float v) {
        location.x = x;
        location.y = y;
        location.z = z;
        location.w = 1;
    ...
    public void set(QVertex vertice) {
    ...
    public void copyAttribute(QVertex other) {
    ...
    public QVertex clone() {
        QVertex result = new QVertex(location.x, location.y, location.z, location.w, u, v);
    ...
    public QVertex multiply(float valor) {
        this.location.multiply(valor);
        normal.multiply(valor);
        return this;
    }

    public QVertex add(float valor) {
        this.location.add(valor);
        normal.add(valor);
        return this;
    }

    public static QVertex promediar(QVertex... vert) {
        QVertex ve = new QVertex();
        for (QVertex v : vert) {
    ...
    public static QVertex sumar(QVertex... vert) {
        QVertex ve = new QVertex();
        for (QVertex v : vert) {
            ve.location.x += v.location.x;
            ve.location.y += v.location.y;
