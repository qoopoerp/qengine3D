...
public class QInputManager {
    ...
    private static Logger logger = Logger.getLogger("input-manager");
    ...
    public static void addMouseListener(QMouseReceptor receptor) {
        listaReceptoresMouse.add(receptor);
    }

    public static void removeMouseListener(QMouseReceptor receptor) {
        listaReceptoresMouse.remove(receptor);
    }

    public static void addKeyboardListener(QTecladoReceptor receptor) {
        listaReceptoresTeclado.add(receptor);
    }

    public static void removeKeyboardListener(QTecladoReceptor receptor) {
        listaReceptoresTeclado.remove(receptor);
    }

    public static void processKeyboardListener(java.awt.event.KeyEvent evt, int tipo) {
    ...
    public static void processMouseListener(MouseEvent evt, int tipo) {
