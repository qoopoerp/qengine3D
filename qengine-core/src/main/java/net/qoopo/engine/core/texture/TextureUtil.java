...
public class TextureUtil {
     ...
     * Negative X, Positive Y, Negative Y, Positive Z,
     * Negative Z.[4][5] The images are stored with the origin at the lower left of
     * the image.
     * The Positive X and Y faces must reverse the Z coordinate and the Negative Z
     * face must negate the X coordinate.
     * If given the face, and texture coordinates {\displaystyle (u,v)} (u,v),
     * the non-normalized vector {\displaystyle (x,y,z)} (x,y,z) can be computed by
     * the function:
     * 
     * 
     * void convert_cube_uv_to_xyz(int index, float u, float v, float *x, float *y,
     * float *z)
     * {
