 ...
 * @author alberto
 */
public class PnlColisionCono extends javax.swing.JPanel {

    private QColisionCono cono;

    /**
     * Creates new form PnlCubo
     */
    public PnlColisionCono(QColisionCono cono) {
        initComponents();
        this.cono = cono;

        txtRadio.setText(String.valueOf(cono.getRadio()));
        txtAltura.setText(String.valueOf(cono.getAltura()));
    }

    private void aplicarCambios() {
        cono.setRadio(Float.parseFloat(txtRadio.getText()));
        cono.setAltura(Float.parseFloat(txtAltura.getText()));
    }
                ...
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addComponent(txtRadio, javax.swing.GroupLayout.DEFAULT_SIZE, 117,
                                                Short.MAX_VALUE)))
