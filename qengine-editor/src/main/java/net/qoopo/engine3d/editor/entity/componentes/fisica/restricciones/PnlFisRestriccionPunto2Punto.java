 ...
 * @author alberto
 */
public class PnlFisRestriccionPunto2Punto extends javax.swing.JPanel {

    private QRestriccionPunto2Punto componente;
    private Map<String, QObjetoRigido> mapa = new HashMap<String, QObjetoRigido>();

    /**
     * Creates new form PnlCubo
     */
    public PnlFisRestriccionPunto2Punto(QRestriccionPunto2Punto componente) {
        initComponents();
