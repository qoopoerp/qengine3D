...
public class QNodoColorVidrio extends ShaderNode {
    ...
    private void calcularEntorno(RenderEngine render, QPixel pixel) {
        ...
        if (render.opciones.isMaterial() // esta activada la opción de material
            ...
            try {
                ...
                colorReflejo = QTexturaUtil.getColorMapaEntorno(tm.vector3f3, enTextura.getProcesadorTextura(),
                        tipoMapaEntorno);
                ...
                tm.vector3f4.set(QMath.refractarVector(tm.vector3f1, tm.vector3f2, indiceRefraccion)); // indice del
                                                                                                       ...
                                                                                                       // indice del
                                                                                                       // material
                colorRefraccion = QTexturaUtil.getColorMapaEntorno(tm.vector3f4, enTextura.getProcesadorTextura(),
                        tipoMapaEntorno);
