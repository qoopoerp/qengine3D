...
public class QNodoColorIluminacion extends ShaderNode {
    ...
    private void calcularIluminacion(RenderEngine render, QIluminacion iluminacion, QPixel pixel) {
        pixel.normal.normalize();
                ...
                for (QLigth luz : render.getLitgths()) {
                    ...
                    if (luz != null && luz.entity.isToRender() && luz.isEnable()) {
                        ...
                        if (proc != null && render.opciones.isSombras()) {
                            ...
                            factorSombra = proc.factorSombra(QTransformar.transformarVectorInversa(tv.vector3f1,
