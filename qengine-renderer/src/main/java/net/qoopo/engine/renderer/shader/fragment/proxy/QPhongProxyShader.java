...
import net.qoopo.engine.renderer.shader.fragment.basico.parciales.QPhongShaderBAS;
 ...
 * @author alberto
 */
public class QPhongProxyShader extends FragmentShader {

    private FragmentShader basico;
    private NodeFragmentShader nodos;

    public QPhongProxyShader(RenderEngine render) {
        super(render);
        basico = new QPhongShaderBAS(render);
