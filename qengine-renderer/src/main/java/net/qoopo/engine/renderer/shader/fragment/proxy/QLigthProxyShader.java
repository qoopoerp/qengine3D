...
import net.qoopo.engine.renderer.shader.fragment.basico.parciales.QIluminadoShaderBAS;
 ...
 * @author alberto
 */
public class QLigthProxyShader extends FragmentShader {

    private FragmentShader basico;
    private NodeFragmentShader nodos;

    public QLigthProxyShader(RenderEngine render) {
        super(render);
        basico = new QIluminadoShaderBAS(render);
