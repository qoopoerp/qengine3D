...
import net.qoopo.engine.renderer.shader.fragment.basico.parciales.QShadowShaderBAS;
 ...
 * @author alberto
 */
public class QShadowProxyShader extends FragmentShader {

    private FragmentShader basico;
    private NodeFragmentShader nodos;

    public QShadowProxyShader(RenderEngine render) {
        super(render);
