...
class ColumnScene extends Group {
    ...
    public ColumnScene(Component observer) {
        ...
        // Load textures
        TextureLoader texLoader = new TextureLoader("assets/textures/piso/cesped/cesped1.jpg", observer);
        ...
        texLoader = new TextureLoader("assets/textures/piso/piso2.jpg", observer);
        ...
        texLoader = new TextureLoader("assets/textures/piso/piso1.jpg", observer);
