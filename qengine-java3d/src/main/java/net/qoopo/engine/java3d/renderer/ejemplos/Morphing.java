...
public class Morphing extends Applet {
    ...
    public void init() {
        if (objFiles == null) {
            ...
            try {
                objFiles[0] = new java.net.URL("assets/models/obj/VARIOS/hand1.obj");
                objFiles[1] = new java.net.URL("assets/models/obj/VARIOS/hand2.obj");
                objFiles[2] = new java.net.URL("assets/models/obj/VARIOS/hand3.obj");
    ...
    public static void main(String[] args) {
        ...
        try {
            urls[0] = new java.net.URL("file:" + "assets/models/obj/VARIOS/hand1.obj");
            urls[1] = new java.net.URL("file:" + "assets/models/obj/VARIOS/hand2.obj");
            urls[2] = new java.net.URL("file:" + "assets/models/obj/VARIOS/hand3.obj");
        } catch (java.net.MalformedURLException ex) {
            System.out.println(ex.getMessage());
            System.exit(1);
        }
