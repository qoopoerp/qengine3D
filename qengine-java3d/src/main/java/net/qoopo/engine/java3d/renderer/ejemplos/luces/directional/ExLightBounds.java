 ...
 */
package net.qoopo.engine.java3d.renderer.ejemplos.luces.directional;
...
class ExamineViewerBehavior extends ViewerBehavior {
     ...
     *
     * @param transformGroup The transform group to be modified by the behavior.
     * @param parent         The AWT Component that contains the area generating
     *                       mouse
     *                       events.
     */
...
class WalkViewerBehavior extends ViewerBehavior {
     ...
     *                       by the behavior
     *
     * @param parent         a parent AWT Component within which the cursor will
     *                       change
     *                       during mouse drags
     *
     * @return a new WalkViewerBehavior that needs its TransformGroup and parent
