...
public class Java3DRenderer extends RenderEngine {
    ...
    public Java3DRenderer(Scene universo, Superficie superficie, int ancho, int alto) {
        super(universo, superficie, ancho, alto);
        // preIniciar();
    }

    public Java3DRenderer(Scene universo, String nombre, Superficie superficie, int ancho, int alto) {
