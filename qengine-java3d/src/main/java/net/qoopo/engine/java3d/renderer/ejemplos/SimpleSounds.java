...
public class SimpleSounds extends Frame implements ActionListener {
    ...
    protected BranchGroup buildContentBranch() {
        ...
        addObjectSound(cubeGroup, sound1, "file:" + "assets/audio/wav/birds1.wav", 10.0f);
        addObjectSound(cubeGroup, sound2, "file:" + "assets/audio/wav/vaca.wav", 20.0f);
        addBackgroundSound(contentBranch, "file:" + "assets/audio/wav/goteo.wav");
