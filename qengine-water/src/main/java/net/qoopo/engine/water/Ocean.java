...
public class Ocean extends Water {
    ...
    public Ocean(Scene scene, int width, int height, int sections) {
        this.width = width;
        this.height = height;
        this.scene = scene;
    ...
    public Ocean(Scene scene, int width, int height, int sections, WaveDistortion waveDistortion) {
        this.width = width;
        this.height = height;
        this.scene = scene;
        this.sections = sections;
    ...
    public void update(RenderEngine mainRender, Scene universo) {
        ...
        // mesh.build(); // regenera el plano
        mesh.reset(); //reinicia las coordenadas de los vértices para que no se acumulen las distorciones
