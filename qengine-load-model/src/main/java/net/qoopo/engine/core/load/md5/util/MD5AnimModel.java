...
public class MD5AnimModel {
    ...
    public MD5AnimModel(String nombre) {
        frames = new ArrayList<>();
        this.nombre = nombre;
    }
    ...
    public static MD5AnimModel parse(String animFile) throws Exception {
        ...
        String nombre = new File(animFile).getName().toLowerCase();

        nombre = nombre.replaceAll(".md5anim", "");
        MD5AnimModel result = new MD5AnimModel(nombre);
