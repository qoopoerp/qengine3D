package net.qoopo.engine.core.load.collada.thinmatrix.xmlParser;
...
public class XmlNode {
     ...
     *
     * @param data - the data for this node (text that is found between the
     * start and end tags of this node).
     */
