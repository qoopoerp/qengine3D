...
public class MD5Model {
    ...
    public static MD5Model parse(String meshModelFile) throws Exception {
        ...
        String nombre = new File(meshModelFile).getName().toLowerCase();
        nombre = nombre.replaceAll(".md5mesh", "");
        MD5Model result = new MD5Model(nombre);
