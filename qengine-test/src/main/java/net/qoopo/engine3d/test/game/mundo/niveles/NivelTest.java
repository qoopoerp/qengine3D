...
import net.qoopo.engine3d.test.game.generadores.GeneradorCasas;
import net.qoopo.engine3d.test.game.generadores.GeneradorLamparas;
...
public class NivelTest extends QEscenario {
    ...
    public void cargar(Scene universo) {
    ...
    private void crearObjetosAleatorios(HeightMapTerrain terreno, Scene universo) {
        ...
        try {
            ...
            AudioBuffer bufFuego = AssetManager.get().loadAudio("assets/audio/ogg/fire.ogg", "au_beep");
            AudioBuffer bufBeep = AssetManager.get().loadAudio("assets/audio/ogg/beep.ogg", "au_beep");
                ...
                if (fogatas) {
                    if (i % 200 == 0) {
                        ...
                        try {
                            ...
                            fogata.addComponent(emisorAudio);
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                        universo.addEntity(fogata);
                    }
                }
                // CASA 1 piso
                if (casas_1p) {
                ...
                if (pinos) {
                    if (i % 20 == 0) {
                        ...
                        try {
                            ...
                            // sourceBeep.play();
                            pino.addComponent(sourceBeep);
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                        universo.addEntity(pino);
                    }
                }
                //// ARBOL
                if (arboles1) {
    ...
    private void crearCielo(Scene universo) {
        ...
        universo.setAmbientColor(new QColor(0.5f, 0.5f, 0.5f));
