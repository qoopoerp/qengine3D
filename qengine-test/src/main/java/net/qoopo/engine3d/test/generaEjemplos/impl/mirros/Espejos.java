...
public class Espejos extends MakeTestScene {
    ...
    public void make(Scene mundo) {
        ...
        espejo1.addComponent(QMaterialUtil.aplicarMaterial(new QPlanoBillboard(2, 2), new QMaterialBas(texEspejo1)));
        ...
        espejo2.addComponent(QMaterialUtil.aplicarMaterial(new QPlanoBillboard(2, 2), new QMaterialBas(textEspejo2)));
        ...
        espejo3.addComponent(QMaterialUtil.aplicarMaterial(new QPlanoBillboard(2, 2), new QMaterialBas(textEspejo3)));
        ...
        espejoCentral.addComponent(QMaterialUtil.aplicarMaterial(new QEsfera(0.5f), mat));
