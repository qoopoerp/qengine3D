...
public class MonstruosDoom {
    ...
    public static void main(String[] args) {
        ...
        Entity doomMonster = (Entity) SerializarUtil.leerObjeto("assets/models/qengine/doom/hellknight.qengine", 0,
                true);
        ...
        quake1.move(100, 0, 0);
        quake1.addComponent(
                ((AnimationStorageComponent) ComponentUtil.getComponent(quake1, AnimationStorageComponent.class))
                        .get("idle1"));
        ...
        quake2.move(0, 0, -100);
        quake2.addComponent(
                ((AnimationStorageComponent) ComponentUtil.getComponent(quake2, AnimationStorageComponent.class))
                        .get("idle02"));
        ...
        quake3.addComponent(
                ((AnimationStorageComponent) ComponentUtil.getComponent(quake3, AnimationStorageComponent.class))
                        .get("idle"));
